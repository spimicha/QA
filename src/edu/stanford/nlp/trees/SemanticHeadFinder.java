...
public class SemanticHeadFinder extends ModCollinsHeadFinder {
  ...
  private void ruleChanges() {
    ...
    if (makeCopulaHead) {
      nonTerminalInfo.put("SQ", new String[][]{{"left", "NN", "NNP", "NNPS", "NNS", "NP", "VP", "SQ", "VB", "VBZ", "VBD", "VBP", "MD", "AUX", "AUXG", "ADJP"}});
    } else {
      nonTerminalInfo.put("SQ", new String[][]{{"left", "NN", "NNP", "NNPS", "NNS", "NP", "VP", "SQ", "ADJP", "VB", "VBZ", "VBD", "VBP", "MD", "AUX", "AUXG"}});
    }
