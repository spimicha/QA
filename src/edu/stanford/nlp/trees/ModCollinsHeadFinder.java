...
public class ModCollinsHeadFinder extends CollinsHeadFinder {
  ...
  public ModCollinsHeadFinder(TreebankLanguagePack tlp) {
    ...
    nonTerminalInfo.put("SBARQ", new String[][]{{"left", "NN", "NNP", "NNPS", "NNS", "NP", "SQ", "S", "SINV", "SBARQ", "FRAG", "SBAR"}});
    ...
    nonTerminalInfo.put("SINV", new String[][]{{"left", "NN", "NNP", "NNPS", "NNS", "NP", "VBZ", "VBD", "VBP", "VB", "MD", "VBN", "VP", "S", "SINV", "ADJP", "JJP", "NP"}});
    nonTerminalInfo.put("SQ", new String[][]{{"left", "NN", "NNP", "NNPS", "NNS", "NP", "VBZ", "VBD", "VBP", "VB", "MD", "AUX", "AUXG", "VP", "SQ"}});  // TODO: Should maybe put S before SQ for tag questions. Check.
    ...
    nonTerminalInfo.put("VP", new String[][]{{"left", "TO", "NN", "NP", "VBD", "VBN", "MD", "VBZ", "VB", "VBG", "VBP", "VP", "AUX", "AUXG", "ADJP", "JJP", "NN", "NNS", "JJ", "NP", "NNP"}});
